...
//		Table
//---------------------------------------------------------
const VasVoiceParameter VasVoiceContext::tVasVoiceParameter[MAX_VAS_VOICE_NUMBER] = {
	...
	{	//1
		{
			70,		//VP_VOLUME,			//	0 - 100
			3,		//VP_AEG_ATTACK_TIME,	//	0 - 1000 (10ms)
			100,	//VP_AEG_DECAY1_LEVEL,	//	0 - 100
			0,		//VP_AEG_DECAY1_TIME,	//	0 - 1000 (10ms)
			100,	//VP_AEG_DECAY2_LEVEL,	//	0 - 100
			0,		//VP_AEG_DECAY2_TIME,	//	0 - 1000 (10ms)
			3,		//VP_AEG_RELEASE_TIME,	//	0 - 1000 (10ms)
		...
		},
		{
			...
			0,		//VP_LFO_FREQUENCY,		//	0 - ??? (*0.1[Hz])
			0,		//VP_LFO_DELAY_TIME,	//	0 - ??? (*10ms)
			0,		//VP_LFO_FADEIN_TIME,	//	0 - ??? (*10mc)
			0,		//VP_LFO_PMD,			//	0 - 100 %
		},
		{
			0,		//VP_FILTER_TYPE,		//	0:LPF,
			10000,	//VP_FILTER_CUTOFF,		//	[Hz]
			1,		//VP_FILTER_RESO,		//	1 - 100 ?
